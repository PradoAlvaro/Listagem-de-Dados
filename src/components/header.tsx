    ...
    <div className="max-w-[1200px] mx-auto flex items-center justify-between">
      ...
      <div className="flex items-center gap-3">
        <div className="flex flex-col items-end gap-0.5">
          <span className="text-sm font-medium">Álvaro Prado</span>
          <span className="text-xs text-zinc-400">alvaro.prado@nivo.video</span>
        </div>
        <img
          src="https://avatars.githubusercontent.com/u/106787656?s=400&u=c61e28f8f71550bd6efd25c3b3032647526816d9&v=4"
